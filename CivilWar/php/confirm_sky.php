...
*******************************/
/* データの受け取り */
$name = $_POST["namae"]; //お名前
$email = $_POST["mailadress"]; //メールアドレス
$game = $_POST["game"]; //ゲーム
...
$email	= htmlspecialchars($mailadress, ENT_QUOTES);
...
//[前のページへ戻る]ボタンを表示する
	...
	echo '<dt>【メールアドレス】</dt><dd>'.$mailadress.'</dd>';
	echo '<dt>【お問い合わせ内容】</dt><dd>'.nl2br($naiyou).'</dd>';
	echo '</dl>';

//[上記内容で送信する]ボタンを表示する
	echo '<form method="post" action="http://kadaiken.php.xdomain.jp/mailpost_sky.php">';
